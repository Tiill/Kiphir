...
class CheckThread extends Thread{
    ...
    public CheckThread(UpdateButton mainbutton, JFrame mainframe) {
        button = mainbutton;
        mainFrame = mainframe;
        setDaemon(true);
    }
...
//Запрос
            String zapros = "#" + Kiphir.getNameprogramm() + "#zapros#" + Kiphir.getVersion() + "#";
...
//Разбор ответа
            ...
            if (null != answer) switch (answer) {
                ...
                case "ok":
                    ...
                    break;
                default:
                    Logger.getLogger(CheckThread.class.getName()).log(Level.SEVERE, null, "Неверный ответ сервера.");
                    break;
            } else {
...
//            Logger.getLogger(CheckThread.class.getName()).log(Level.SEVERE, null, ex);
            Logger.getLogger(CheckThread.class.getName()).log(Level.SEVERE, "Сервер обновлений недоступен.", "");
        }
    }
